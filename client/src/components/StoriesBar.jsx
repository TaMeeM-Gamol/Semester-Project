      ...
      <div className='flex gap-4 pb-5'>
        ...
        {stories.map((story, index) => (
          ...
          hover:from-indigo-700 hover:to-purple-800 active:scale-95' >
            <img src={story.user?.profile_picture || undefined} alt='' className='absolute size-8 top-3 left-3 z-10 rounded-full ring ring-gray-100 shadow'/>
            ...
            <p className='text-white absolute bottom-1 right-2 z-10 text-xs'>
             ...
             <img src={story.media_url || undefined} alt='' className='w-full h-full object-cover hover:scale-110 transition duration-500 opacity-70 hover:opacity-80'/>
              :
              <video src={story.media_url || undefined} className='w-full h-full object-cover hover:scale-110 transition duration-500 opacity-70 hover:opacity-80'/>
            }
                  </div>
                )
