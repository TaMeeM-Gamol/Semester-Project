import { BadgeCheck, Heart, Images, MessageCircle, Share2Icon } from 'lucide-react'
...
const PostCard = ({post}) => {
  ...
  return (
    <div className='bg-white rounded-xl shadow p-4 space-y-4 w-full max-w-2xl'>
       ...
       {/* {content} */}
       {post.content && <div className='text-gray text-sm whitespace-pre-line' dangerouslySetInnerHTML={{__html : postWithHashtags}}/>}
