      ...
      <div className='flex flex-col md:flex-row items-start gap-6'>
        ...
        <div className='w-full pt-16 md:pt-0 md:pl-36'>
          <div className='flex flex-col md:flex-row items-start justify-between'>
            ...
            {/* {if user is not on others profile that means he is opening his profile sp we will give edit button} */}

            {
                !profileId && 
                <button onClick={()=> setShowEdit(true)} className='flex items-center gap-2 border border-gray-300 hover:bg-grau-50 px-4 py-2
          ...
          <div className='flex items-center gap-6 mt-6 border-t bprder-gray-200 pt-4'>
             <div>
             ...
             <div>
              ...
              <span className='text-xs sm:text-sm text-gray-500 ml-1.5'>Follwing</span>
             </div>
          </div>
        </div>
      </div>
